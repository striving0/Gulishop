...
import com.wzw.gulishop.product.dao.AttrDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void saveAttr(AttrVo attr) {
        ...
        //2.保存关联关系
        if (attr.getAttrType() == ProductConstant.AttrEnum.ATTR_TYPE_BSE.getCode() && attr.getAttrGroupId() != null) {
    ...
    public PageUtils queryBaseAttrPage(Map<String, Object> params, Long catelogId, String type) {
        QueryWrapper<AttrEntity> queryWrapper = new QueryWrapper<AttrEntity>().eq("attr_type", "base".equalsIgnoreCase(type) ? ProductConstant.AttrEnum.ATTR_TYPE_BSE.getCode() : ProductConstant.AttrEnum.ATTR_TYPE_SALE.getMsg());
...
//        relationDao.delete(new QueryWrapper<>().eq("attr+id", 1L).eq("attr_group_id", 1L));
     ...
     */
    @Override
    public PageUtils getNoaRelationAttr(Map<String, Object> params, Long attrgroupId) {
        ...
        QueryWrapper<AttrEntity> wrapper = new QueryWrapper<AttrEntity>().eq("catelog_id", catelogId).eq("attr_type", ProductConstant.AttrEnum.ATTR_TYPE_BSE.getCode());
        if (attrIds != null && attrIds.size() > 0) {
